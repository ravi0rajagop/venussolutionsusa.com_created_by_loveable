...
import appdevHeroImg from "@/assets/appdev-hero.jpg";
  ...
  <main>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <motion.div initial="hidden" animate="visible" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={fadeUp} custom={2} className="hidden lg:block">
            <img src={appdevHeroImg} alt="Application development and architecture" className="rounded-lg shadow-card-hover w-full h-80 object-cover" />
          </motion.div>
        </motion.div>
      </div>
    </section>
    ...
    <div className="lg:hidden bg-background">
      <div className="container mx-auto px-4 -mt-6 relative z-20">
        <img src={appdevHeroImg} alt="Application development" className="rounded-lg shadow-card-hover w-full h-48 object-cover" />
      </div>
    </div>
